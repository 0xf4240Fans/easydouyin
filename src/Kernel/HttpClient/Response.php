...
use ArrayAccess;
use Closure;
use EasyDouYin\Kernel\Contracts\Arrayable;
use EasyDouYin\Kernel\Contracts\Jsonable;
use EasyDouYin\Kernel\Exceptions\BadMethodCallException;
use EasyDouYin\Kernel\Exceptions\BadResponseException;
...
class Response implements Jsonable, Arrayable, ArrayAccess, ResponseInterface, StreamableInterface
{
    ...
    public function toArray(bool $throw = null): array
    {
        ...
        if ('' === $this->response->getContent($throw)) {
